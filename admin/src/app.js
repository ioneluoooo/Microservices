...
dataSource.initialize()
    ...
    return __generator(this, function (_a) {
        ...
        amqp.connect('amqps://dmxrsfku:z3953IdAtawCGTJ4aVyf8pVNWOV9cdNi@rattlesnake.rmq.cloudamqp.com/dmxrsfku', function (error, connection) {
            if (error) {
                throw error;
            }
            connection.createChannel(function (err, channel) {
                ...
                app.listen(PORT, function () {
                    console.log("Server is launched at port ".concat(PORT));
                    ...
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0:
                                ...
                                return [4 /*yield*/, productRepository.findOne({ where: { id: productId } })];
                            case 1:
                                product = _a.sent();
                                product.likes++;
                                return [4 /*yield*/, productRepository.save(product)];
                ...
                app.delete('/api/products/:id', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
                    var productId, product, deleteResult;
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0:
                                productId = req.params.id;
